...
def checkFile(file):
    print(file)
    model = joblib.load("C:\\D\\PCS-Project-TEAM-5\\ML\\model\\model.pkl")
    features = pickle.loads(open(os.path.join('C:\\D\\PCS-Project-TEAM-5\\ML\\model\\features.pkl'), 'rb').read())
